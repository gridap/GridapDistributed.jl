...
function Gridap.FESpaces.collect_cell_residual(
  uh::DistributedFEFunction,v::DistributedCellBasis,terms)
...
function Gridap.FESpaces.collect_cell_vector(
  uhd::DistributedFEFunction,v::DistributedCellBasis,terms)
...
function Gridap.FESpaces.collect_cell_matrix_and_vector(
  uhd::DistributedFEFunction,u::DistributedCellBasis,v::DistributedCellBasis,terms)
